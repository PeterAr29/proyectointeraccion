...
- **M4 — V1.0 en producción (`v1.0.0`):** ✅ **alcanzado 2026-07-11.** F6 cerrada (endurecimiento de seguridad + PWA instalable + política de privacidad + e2e en CI). **Proyecto completo.** Resta la entrega operativa: SUS real, push a producción y verificación de Lighthouse PWA en móvil.

...
| T-014 Préstamos/devoluciones/multas (F5.3) | E      | —          | Disponible (siguiente) |

> El resto de tareas (T-015…T-017) están Bloqueadas por sus dependencias. Ver `docs/backlog.md`.
